...
update-translations:
	pybabel extract -F babel.cfg -k lazy_gettext -o protected_route/translations/messages.pot .
	pybabel update -i protected_route/translations/messages.pot -d protected_route/translations/

add-translation:
	@read -p "Enter new language shortcode:" lang; \
	pybabel init -i protected_route/translations/messages.pot -d protected_route/translations/ -l $$lang

compile-translations:
	pybabel compile -d protected_route/translations/
